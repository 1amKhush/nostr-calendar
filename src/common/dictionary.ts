...
const dictionary: NestedObject = {
  "en-US": {
    ...
    event: {
      ...
      notificationInherit: "Use calendar default",
      notificationDefault: "10 minutes before and at event start",
      notificationOff: "No notifications",
    },
    deleteEvent: {
      title: "Delete Event",
  ...
  "de-DE": {
    ...
    event: {
      ...
      notificationInherit: "Kalenderstandard verwenden",
      notificationDefault: "10 Min. vorher und zum Start",
      notificationOff: "Keine Benachrichtigungen",
    },
    deleteEvent: {
