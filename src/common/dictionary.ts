...
const dictionary: NestedObject = {
  "en-US": {
    ...
    login: {
      ...
      signInWithNsec: "Sign in with nsec key",
      ...
      enterNsec: "Enter your nsec key to continue.",
      enterNsecPlaceholder: "nsec1...",
      ...
      loggedInWithNsec: "Signed in with nsec key",
      loginFailed: "Login failed.",
      noNip07Extension: "No NIP-07 extension found.",
      invalidNsec: "Invalid nsec key. Please try again.",
  ...
  "de-DE": {
    ...
    login: {
      ...
      signInWithNsec: "Mit nsec-Schlüssel anmelden",
      ...
      enterNsec: "Geben Sie Ihren nsec-Schlüssel ein, um fortzufahren.",
      enterNsecPlaceholder: "nsec1...",
      ...
      loggedInWithNsec: "Mit nsec-Schlüssel angemeldet",
      loginFailed: "Anmeldung fehlgeschlagen.",
      noNip07Extension: "Keine NIP-07-Erweiterung gefunden.",
      invalidNsec: "Ungültiger nsec-Schlüssel. Bitte erneut versuchen.",
